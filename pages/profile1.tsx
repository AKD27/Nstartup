...
const ConsultingPageProfile1 = () => {
  return (
    <div className="w-full relative bg-background-color overflow-hidden flex flex-col items-start justify-start pt-[0rem] px-[0rem] pb-[362.5rem] box-border gap-[1.625rem] leading-[normal] tracking-[normal] text-left text-[2rem] text-black font-aktivgrotesk-medium">
      <div className="self-stretch flex flex-row items-start justify-center pt-[1.562rem] pb-[1.187rem] pr-[1.25rem] pl-[3.75rem] box-border relative max-w-full mq1225:pl-[1.875rem] mq1225:box-border">
        ...
        <div className="w-[74.706rem] flex flex-col items-end justify-start gap-[3rem] max-w-full mq750:gap-[1.5rem]">
                ...
                <div className="self-stretch w-[19.025rem] flex flex-row items-end justify-between gap-[1.25rem] text-[0.875rem] text-primary">
                  <div className="self-stretch flex flex-row items-start justify-start py-[0rem] pr-[0.687rem] pl-[0rem] gap-[0.312rem]">
                    <div className="self-stretch flex flex-col items-start justify-start pt-[0.5rem] px-[0rem] pb-[0rem]">
                      <img
                        className="w-[2.719rem] flex-1 relative max-h-full z-[1]"
                        loading="lazy"
                        alt=""
                        src="/group-21.svg"
                      />
                  ...
                  <div className="flex flex-col items-start justify-end pt-[0rem] px-[0rem] pb-[0.393rem]">
                    <div className="flex flex-row items-start justify-start gap-[0.312rem]">
                      <div className="flex flex-col items-start justify-start pt-[0.25rem] px-[0rem] pb-[0rem]">
                        <img
                          className="w-[2.719rem] h-[2.688rem] relative z-[1]"
                          alt=""
                          src="/vector-1.svg"
                        />
                      </div>
          ...
          <div className="w-[70.688rem] flex flex-row items-start justify-end py-[0rem] px-[3.437rem] box-border max-w-full mq1225:pl-[1.688rem] mq1225:pr-[1.688rem] mq1225:box-border">
